...
default_spec_instrs = 30
default_gap_instrs = 30
...
default_prefetcher_binary = 'bin/hashed_perceptron-no-from_file-no-no-lru-1core'
...
def build_command():
    ...
    if build in ['all', 'prefetcher']:
        ...
        os.system('./build_champsim.sh hashed_perceptron no from_file no no lru 1')
